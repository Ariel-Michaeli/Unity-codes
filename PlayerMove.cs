...
public class PlayerMove : MonoBehaviour
{
    ...
    //Movement speed
    float BaseVelocity = 0.0155f;

    float JumpDirectionForce = 205;
    ...
    void Update()
    {
        ...
        {
            rb.MovePosition(rb.position + transform.forward * BaseVelocity);
            Debug.Log("W");
        }
        ...
        {
            rb.MovePosition(rb.position + transform.right * BaseVelocity);
            Debug.Log("D");
        }
    ...
    //getting if the Player touches something (most of the time its the ground
